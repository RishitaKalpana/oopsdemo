 ...
 *   is used at the class level and allows the class 
...
public class ProductRestController {
	...
	//Browse - http://localhost:8085/ims/api/products/3 (here 3 is a ID)
	...
	//In Postman - DELETE - http://localhost:8085/ims/api/products/6
