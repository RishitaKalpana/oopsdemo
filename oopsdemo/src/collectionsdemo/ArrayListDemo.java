...
public class ArrayListDemo {
	...
	public static void main(String[] args) {
		...
		a1.add("C++");
		a1.add("C# 5.0");
		a1.add("Java");//can store duplicate elements and can maintain the order how it is inserted
        ...
        System.out.println("Is Arraylist Empty ? :"+a1.isEmpty());//this method belongs to arraylist class
        System.out.println("Index of Perl :"+a1.indexOf("Perl"));
        System.out.println("Size of Arraylist : "+a1.size());
       
        Collections.sort(a1);//utility class called collections 
